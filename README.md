WiFi dataset for model selection (Original Work)
========================
...
Citation request
========================
When using this dataset, please cite the following three original works:
```
...
Our Work
```
@article{rana2025wifi,
  title={WiFi RSS and RTT Indoor Positioning with Graph Temporal Convolution Network},
  author={Rana, Lila and Dulal, Aayush},
  journal={Sensors},
  volume={25},
  number={24},
  pages={7622},
